...
// Mirrors positron-data-driver-sqlite's workerEnv.ts; the two extensions are packaged
// independently, so each carries its own copy of the fork environment scrub.
