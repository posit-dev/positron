...
**history** | [**Array&lt;ExecutionHistoryEntry&gt;**](ExecutionHistoryEntry.md) | The last few executions the session ran, oldest first. The full history is available from the session\&#39;s history endpoint. | [optional] [default to undefined]
