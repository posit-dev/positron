...
**url** | **string** | The full MCP endpoint URL agents should connect to. Unique to this frontend, so an agent configured with it can only reach this frontend\&#39;s window. | [default to undefined]
