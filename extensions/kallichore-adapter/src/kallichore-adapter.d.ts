...
/**
 * A language runtime that wraps a Jupyter kernel supervised by Kallichore
 */
export interface KallichoreLanguageRuntimeSession extends positron.LanguageRuntimeSession {
	/**
 ...
 */
export interface KallichoreAdapterApi extends vscode.Disposable {
