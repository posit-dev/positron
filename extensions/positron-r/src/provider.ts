...
import { RInstallation, RMetadataExtra, getRHomePath, ReasonDiscovered, friendlyReason, getInterpreterOverridePaths, getDefaultInterpreterPath } from './r-installation';
