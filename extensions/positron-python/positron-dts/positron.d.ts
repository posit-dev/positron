...
declare module 'positron' {
	...
	export interface LanguageRuntimeMetadata {
        ...
        /** The text the language's interpreter uses to prompt the user for input, e.g. ">" (R) or ">>>" (Python) */
        inputPrompt: string;

        /** The text the language's interpreter uses to prompt the user for continued input, e.g. "+" (R) or "..." (Python) */
