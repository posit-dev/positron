...
If you want to add more functionality, you can install additional extensions from the [Posit Public Package Manager](https://p3m.dev/openvsx/latest) by [browsing in the Extensions tab](command:workbench.extensions.action.focusExtensionsView).