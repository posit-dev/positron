    ...
    public render() {
        return (
            <div id='plot-toolbar-panel'>
                    <ImageButton baseTheme={this.props.baseTheme} onClick={this.props.prevButtonClicked} disabled={!this.props.prevButtonClicked} tooltip={getLocString('DataScience.previousPlot', 'Previous')}>
                        <Image baseTheme={this.props.baseTheme} class='image-button-image' image={ImageName.Prev}/>
                    </ImageButton>
                    <ImageButton baseTheme={this.props.baseTheme} onClick={this.props.nextButtonClicked} disabled={!this.props.nextButtonClicked} tooltip={getLocString('DataScience.nextPlot', 'Next')}>
