    ...
    [
        ...
        .forEach(item => {
            ...
            setup(() => {
                ...
                stateFactory.setup(f => f.createGlobalPersistentState<string[]>(typemoq.It.isValue(FilterKeys.GlobalDiagnosticFilter), typemoq.It.isValue([])))
                    .returns(() => globalState.object);
                stateFactory.setup(f => f.createWorkspacePersistentState<string[]>(typemoq.It.isValue(FilterKeys.WorkspaceDiagnosticFilter), typemoq.It.isValue([])))
                    .returns(() => workspaceState.object);
                serviceContainer.setup(s => s.get(typemoq.It.isValue(IPersistentStateFactory)))
