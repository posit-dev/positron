...
export interface FilepathsContentProps extends BasePromptElementProps {
}

/**
 * File path handling guidelines for the Positron Assistant.
 * This provides instructions for properly displaying and referencing file paths.
 */
export class FilepathsContent extends PromptElement<FilepathsContentProps> {
	render() {
		return (
