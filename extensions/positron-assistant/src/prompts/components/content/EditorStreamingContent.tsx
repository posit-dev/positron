...
/**
 * Editor streaming content for handling streaming edits in the Positron Assistant.
 */
export class EditorStreamingContent extends PromptElement<EditorStreamingContentProps> {
	render() {
		return (
