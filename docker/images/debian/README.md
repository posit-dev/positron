# Positron CI Environment (Debian 13)

This directory contains Docker configurations used in GitHub Actions for testing Positron against Debian 13 on both ARM64 and AMD64 architectures.

## Directory Structure

- `Dockerfile.debian13` - Dockerfile for AMD64 and ARM64 architectures
...
- `deps/` - Shared dependencies used by both architectures
  - `debian13_packages_amd64.txt` - Package list for AMD64 architecture
  - `debian13_packages_arm64.txt` - Package list for ARM64 architecture
...
## Local Development
See the [Debian Local ARM](../../environments/arm-local/) for details.
