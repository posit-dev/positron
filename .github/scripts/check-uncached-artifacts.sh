...
if [[ $UNCACHED_COUNT -gt 0 ]]; then
	...
	echo "     → Edit .github/scripts/cache-paths.sh"
	...
	echo "     → Run: .github/scripts/verify-cache-paths.sh"
	echo ""
	echo "❌ Option B: Ignore (if tests don't need these files)"
	echo ""
	echo "   Add pattern to IGNORE_PATTERNS in this file:"
	echo "     → .github/scripts/check-uncached-artifacts.sh (Section 3, line ~100)"
	echo ""
