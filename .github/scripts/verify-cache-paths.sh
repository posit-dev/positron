...
# • Check .github/scripts/cache-paths.sh for syntax errors
...
if [ $EXIT_CODE -eq 0 ]; then
	...
	echo "  1. Check .github/scripts/cache-paths.sh for syntax errors"
	echo "  2. Run directly for debugging: .github/scripts/cache-paths.sh"
