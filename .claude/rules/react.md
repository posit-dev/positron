...
This applies to calls nested anywhere inside the initializer expression, not just at the top level. The eager form amplified posit-dev/positron#15427: components rendered per data grid cell each re-read configuration on every render.
