...
This skill replaces the older `/draft-pr-body` command with these improvements:
- **Dynamic tag fetching** - Always up-to-date
- **Richer workflow** - More guided experience
- **Better categorization** - Tags grouped by type
- **Multiple output options** - Clipboard, file, or API

The old command still works but consider using this skill for better results.