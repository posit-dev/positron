...
// 	 */
// 	async append(setting: Setting, restartApp = false) {
// 		await this.appendMultipleSettings([setting], restartApp);
// 	}
...
// 	 */
// 	async appendMultipleSettings(settings: Setting[] = [], restartApp = false) {
