...
export async function JupyterApp(
	...
	const { options, enableDataConnections } = fixtureOptions;
	...
	const start = async () => {
		...
		await setupJupyterEnvironment(enableDataConnections);
 ...
 */
async function setupJupyterEnvironment(enableDataConnections?: boolean): Promise<void> {
