...
export class Application {
	...
	private async checkWindowReady(code: Code): Promise<void> {
		...
		await measureAndLog(() => expect(code.driver.page.locator('.monaco-workbench')).toBeVisible({ timeout: 20000 }), 'Application#checkWindowReady: wait for .monaco-workbench element', this.logger);
