...
_test_setup_1.test.describe('Data Explorer - Python Polars', {
    tag: [_test_setup_1.tags.WIN, _test_setup_1.tags.WEB, _test_setup_1.tags.CRITICAL, _test_setup_1.tags.DATA_EXPLORER]
}, () => {
    _test_setup_1.test.beforeEach(async function ({ app, openFile, runCommand, python }) {
        const { variables, dataExplorer, editors } = app.workbench;
        await openFile((0, path_1.join)('workspaces', 'polars-dataframe-py', 'polars_basic.py'));
    ...
    (0, _test_setup_1.test)('Python Polars - Verify table data, copy to clipboard, sparkline hover, null percentage hover', async function ({ app }) {
    ...
    (0, _test_setup_1.test)('Python Polars - Verify column info functionality: missing %s, profile data', async function ({ app }) {
    ...
    (0, _test_setup_1.test)('Python Polars - Verify can filter column', async function ({ app }) {
        const { dataExplorer } = app.workbench;
    ...
    (0, _test_setup_1.test)('Python Polars - Verify can sort column', async function ({ app }) {
        const { dataExplorer } = app.workbench;
...
//# sourceMappingURL=data-explorer-python-polars.test.js.map