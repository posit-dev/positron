...
exports.normalizeCodeForDisplay = exports.dplyrScript = exports.dataTableScript = exports.tibbleScript = exports.rDataFrameScript = exports.polarsDataFrameScript = exports.pandasDataFrameScript = void 0;
/**
 ...
 */
const normalizeCodeForDisplay = (code) => {
    // Replace newlines with spaces for UI component text comparison
    return code.replace(/\n/g, '');
};
exports.normalizeCodeForDisplay = normalizeCodeForDisplay;
//# sourceMappingURL=convert-to-code-data.js.map