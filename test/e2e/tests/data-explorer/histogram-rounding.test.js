...
_test_setup_1.test.describe('Data Explorer - Histogram Rounding', {
    ...
    for (const testCase of cases) {
        (0, _test_setup_1.test)(testCase.name, async ({ app, python }) => {
...
//# sourceMappingURL=histogram-rounding.test.js.map