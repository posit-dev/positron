...
for (const { env, data, rowIndexOffset: indexOffset } of testCases) {
    _test_setup_1.test.describe('Data Explorer: Pins', { tag: [_test_setup_1.tags.WIN, _test_setup_1.tags.WEB, _test_setup_1.tags.DATA_EXPLORER] }, () => {
        ...
        (0, _test_setup_1.test)(`${env} - Rows and columns can be pinned, unpinned and persist with scrolling`, async function ({ app }) {
        ...
        (0, _test_setup_1.test)(`${env} - Range selection respects pinned columns (excludes vs includes cases)`, async function ({ app }) {
            const { dataExplorer } = app.workbench;
            // pin column2
        ...
        (0, _test_setup_1.test)(`${env} - Cell navigation works with pinned columns and rows`, async function ({ app }) {
            const { dataExplorer } = app.workbench;
        ...
        (0, _test_setup_1.test)(`${env} - Column sorting removes pinned rows`, {
            annotation: [
...
//# sourceMappingURL=data-explorer-pins.test.js.map