...
_test_setup_1.test.describe('Data Explorer - Python Pandas', {
    ...
    (0, _test_setup_1.test)('Python Pandas - Verify can execute cell, open data grid, and data present', async function ({ app, hotKeys, python }) {
        ...
        await notebooks.openNotebook((0, path_1.join)(app.workspacePathOrFolder, 'workspaces', 'data-explorer-update-datasets', pythonNotebook));
...
//# sourceMappingURL=data-explorer-python-pandas.test.js.map