...
_test_setup_1.test.describe('Data Explorer - R ', {
    tag: [_test_setup_1.tags.WEB, _test_setup_1.tags.WIN, _test_setup_1.tags.DATA_EXPLORER, _test_setup_1.tags.WORKBENCH]
}, () => {
    (0, _test_setup_1.test)('R - Verify basic data explorer functionality', { tag: [_test_setup_1.tags.CRITICAL] }, async function ({ app, r, openFile }) {
    ...
    (0, _test_setup_1.test)('R - Verify opening Data Explorer for the second time brings focus back', {
        annotation: [
    ...
    (0, _test_setup_1.test)('R - Verify blank spaces in data explorer and disconnect behavior', async function ({ app, r, executeCode, hotKeys }) {
...
//# sourceMappingURL=data-explorer-r.test.js.map