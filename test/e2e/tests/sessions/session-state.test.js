...
_test_setup_1.test.describe('Sessions: State', {
    ...
    (0, _test_setup_1.test)('Validate session states during start, restart, and shutdown', { tag: [_test_setup_1.tags.ARK] }, async function ({ app, sessions }) {
    ...
    (0, _test_setup_1.test)('Validate state displays as active when executing code', async function ({ app, sessions }) {
        const { console } = app.workbench;
    ...
    (0, _test_setup_1.test)('Validate metadata between sessions', async function ({ app, sessions }) {
        const { console } = app.workbench;
