...
_test_setup_1.test.describe('Sessions: Management', {
    tag: [_test_setup_1.tags.WIN, _test_setup_1.tags.WEB, _test_setup_1.tags.CONSOLE, _test_setup_1.tags.SESSIONS, _test_setup_1.tags.CRITICAL]
}, () => {
    ...
    (0, _test_setup_1.test)('Validate active session list in console matches active session list in session picker', async function ({ app, sessions }) {
    ...
    _test_setup_1.test.skip('Validate session, console, variables, and plots persist after reload', {
        tag: [_test_setup_1.tags.VARIABLES, _test_setup_1.tags.PLOTS],
        annotation: [
...
async function runCodeInSession(app, session, index) {
    await _test_setup_1.test.step(`${session.name}: run code to generate plot and variable`, async () => {
...
//# sourceMappingURL=session-mgmt.test.js.map