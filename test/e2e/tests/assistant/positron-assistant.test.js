 ...
 */
_test_setup_1.test.describe('Positron Assistant Setup', { tag: [_test_setup_1.tags.WIN, _test_setup_1.tags.ASSISTANT, _test_setup_1.tags.WEB] }, () => {
    /**
     ...
     */
    (0, _test_setup_1.test)('Verify Posit AI is first provider in modal', async function ({ app }) {
        ...
        (0, _test_setup_1.expect)(providerNames[0]).toBe('Posit AI');
     ...
     * @param app - Application fixture providing access to UI elements
     */
    (0, _test_setup_1.test)('Anthropic: Verify Bad API key results in error', async function ({ app }) {
        await app.workbench.assistant.openPositronAssistantChat();
        await app.workbench.assistant.clickConfigureProvidersButton();
        ...
        await (0, _test_setup_1.expect)(app.workbench.assistant.verifySignOutButtonVisible(5000)).rejects.toThrow();
        await app.workbench.assistant.clickCloseButton();
    });
    /**
     ...
     * @param app - Application fixture providing access to UI elements
     */
    (0, _test_setup_1.test)('Anthropic: Verify Successful API Key Sign in and Sign Out', async function ({ app }) {
        await app.workbench.assistant.openPositronAssistantChat();
     ...
     * @param app - Application fixture providing access to UI elements
     */
    (0, _test_setup_1.test)('OpenAI: Verify Successful API Key Sign in and Sign Out', async function ({ app }) {
        await app.workbench.assistant.openPositronAssistantChat();
     ...
     */
    (0, _test_setup_1.test)('Amazon Bedrock: Verify Successful Sign in and Sign Out', async function ({ app }) {
        await app.workbench.assistant.openPositronAssistantChat();
     ...
     * @param app - Application fixture providing access to UI elements
     */
    (0, _test_setup_1.test)('Posit AI: Verify Successful OAuth Sign in and Sign Out', async function ({ app }) {
        await app.workbench.assistant.openPositronAssistantChat();
     ...
     */
    (0, _test_setup_1.test)('Verify Inline Chat opens', async function ({ app, openFile }) {
        await app.workbench.assistant.openPositronAssistantChat();
    ...
    (0, _test_setup_1.test)('Verify Authentication Type When Switching Providers', async function ({ app }) {
 ...
 */
_test_setup_1.test.describe('Positron Assistant Chat Editing', { tag: [_test_setup_1.tags.WIN, _test_setup_1.tags.ASSISTANT, _test_setup_1.tags.WEB] }, () => {
    _test_setup_1.test.beforeAll('Enable Assistant', async function ({ app }) {
        await app.workbench.assistant.openPositronAssistantChat();
        await app.workbench.assistant.loginModelProvider('echo');
    });
    _test_setup_1.test.beforeEach('How to clear chat', async function ({ app }) {
        await app.workbench.assistant.clickNewChatButton();
    });
    _test_setup_1.test.afterAll('Sign out of Assistant', async function ({ app }) {
    ...
    _test_setup_1.test.skip('Python: Verify running code in console from chat markdown response', { tag: [] }, async function ({ app, python }) {
     ...
     */
    // Skipping Console tests due to PR #10784
    _test_setup_1.test.skip('R: Verify running code in console from chat markdown response', { tag: [_test_setup_1.tags.CRITICAL] }, async function ({ app, r }) {
 ...
 */
_test_setup_1.test.describe('Positron Assistant Model Picker Default Indicator', { tag: [_test_setup_1.tags.WIN, _test_setup_1.tags.ASSISTANT, _test_setup_1.tags.WEB] }, () => {
    _test_setup_1.test.beforeAll('Enable Assistant and sign in to Echo provider', async function ({ app }) {
        await app.workbench.assistant.openPositronAssistantChat();
        await app.workbench.assistant.loginModelProvider('echo');
    });
    _test_setup_1.test.afterAll('Sign out of Assistant', async function ({ app }) {
     ...
     */
    (0, _test_setup_1.test)('Verify default model indicator and ordering for single provider', async function ({ settings, assistant }) {
        ...
        (0, _test_setup_1.expect)(echoModels.length).toBeGreaterThanOrEqual(2);
        (0, _test_setup_1.expect)(echoModels[0].label).toBe('Echo Language Model v2 (default)');
        // Close the dropdown
 ...
 * @see https://github.com/posit-dev/positron/pull/11299
 */
_test_setup_1.test.describe('Positron Assistant Model Picker Default Indicator - Multiple Providers', { tag: [_test_setup_1.tags.WIN, _test_setup_1.tags.ASSISTANT, _test_setup_1.tags.WEB] }, () => {
    _test_setup_1.test.beforeAll('Enable Assistant and sign in to providers', async function ({ app }) {
        await app.workbench.assistant.openPositronAssistantChat();
        await app.workbench.assistant.loginModelProvider('echo');
    });
    _test_setup_1.test.afterAll('Sign out of providers and clean up', async function ({ app, settings }) {
        // Clean up settings
        await settings.set({
     ...
     */
    (0, _test_setup_1.test)('Verify default model indicators and ordering for multiple providers', async function ({ settings, assistant }) {
        ...
        (0, _test_setup_1.expect)(anthropicModels.length).toBeGreaterThanOrEqual(2);
        (0, _test_setup_1.expect)(anthropicModels[0].label).toBe('Claude Haiku 4.5 (default)');
        const echoModels = await assistant.getModelPickerItemsForVendor('Echo');
        (0, _test_setup_1.expect)(echoModels.length).toBeGreaterThanOrEqual(2);
        (0, _test_setup_1.expect)(echoModels[0].label).toBe('Echo Language Model v2 (default)');
        // Close dropdown
...
_test_setup_1.test.describe('Positron Assistant Chat Tokens', { tag: [_test_setup_1.tags.WIN, _test_setup_1.tags.ASSISTANT] }, () => {
    _test_setup_1.test.beforeAll('Enable Assistant', async function ({ assistant }) {
        await assistant.openPositronAssistantChat();
        await assistant.loginModelProvider('echo');
    });
    _test_setup_1.test.beforeEach('Clear chat', async function ({ app, settings }) {
    ...
    (0, _test_setup_1.test)('Token usage is displayed in chat response', async function ({ app, assistant }) {
        ...
        (0, _test_setup_1.expect)(tokenUsage).toMatchObject({
            inputTokens: message.length,
            outputTokens: message.length
        });
    });
    (0, _test_setup_1.test)('Token usage is not displayed when setting is disabled', async function ({ app, settings, assistant }) {
        ...
        (0, _test_setup_1.expect)(await assistant.verifyTokenUsageNotVisible());
    });
    (0, _test_setup_1.test)('Token usage is not displayed for non-supported providers', async function ({ app, settings, assistant }) {
        await settings.set({ 'positron.assistant.approximateTokenCount': [] }, { reload: 'web' });
        await assistant.sendChatMessageAndWait('What is the meaning of life?');
        (0, _test_setup_1.expect)(await assistant.verifyTokenUsageNotVisible());
    });
    (0, _test_setup_1.test)('Token usage updates when settings change', async function ({ app, settings, assistant }) {
        await assistant.sendChatMessageAndWait('What is the meaning of life?');
        await assistant.verifyTokenUsageVisible();
        await settings.set({ 'positron.assistant.approximateTokenCount': [] }, { reload: 'web' });
        (0, _test_setup_1.expect)(await assistant.verifyTokenUsageNotVisible());
    ...
    (0, _test_setup_1.test)('Total token usage is displayed in chat header', async function ({ app, assistant }) {
        ...
        (0, _test_setup_1.expect)(totalTokens).toBeDefined();
        (0, _test_setup_1.expect)(totalTokens).toMatchObject({
            inputTokens: message1.length + message2.length,
            outputTokens: message1.length + message2.length
        });
    });
});
//# sourceMappingURL=positron-assistant.test.js.map