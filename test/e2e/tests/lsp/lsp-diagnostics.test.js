...
_test_setup_js_1.test.describe('Diagnostics', {
    tag: [_test_setup_js_1.tags.PYREFLY, _test_setup_js_1.tags.WEB],
}, () => {
    ...
    (0, _test_setup_js_1.test)('Python - Verify diagnostics isolation between sessions in the editor and problems view', async function ({ app, runCommand, sessions }) {
    ...
    (0, _test_setup_js_1.test)('Python - File shows diagnostic for non-existent module import', async function ({ app, runCommand, sessions, python }) {
    ...
    (0, _test_setup_js_1.test)('Python - File shows diagnostic for missing attribute on module', async function ({ app, runCommand }) {
        const { problems, editor } = app.workbench;
        await runCommand('Python: New File');
    ...
    (0, _test_setup_js_1.test)('Python - File shows diagnostic for calling non-callable', async function ({ app, runCommand }) {
        const { problems, editor } = app.workbench;
        await runCommand('Python: New File');
    ...
    (0, _test_setup_js_1.test)('Python - File shows diagnostic for incompatible assignment (annotated int)', async function ({ app, runCommand }) {
        const { problems, editor } = app.workbench;
        await runCommand('Python: New File');
    ...
    (0, _test_setup_js_1.test)('Python - File shows diagnostic for wrong return type', async function ({ app, runCommand }) {
        const { problems, editor } = app.workbench;
        await runCommand('Python: New File');
    ...
    (0, _test_setup_js_1.test)('Python - File shows diagnostic for list element type mismatch', async function ({ app, runCommand }) {
        const { problems, editor } = app.workbench;
        await runCommand('Python: New File');
    ...
    (0, _test_setup_js_1.test)('Python - File shows diagnostic for dict value type mismatch', async function ({ app, runCommand }) {
        const { problems, editor } = app.workbench;
        await runCommand('Python: New File');
    ...
    (0, _test_setup_js_1.test)('Python - File shows type errors when indentation error is present', async function ({ app, runCommand, sessions, python }) {
        const { problems, editor } = app.workbench;
        await runCommand('Python: New File');
    ...
    _test_setup_js_1.test.skip('Python - QMD file shows diagnostic for undefined variable', async function ({ app, runCommand }) {
    ...
    (0, _test_setup_js_1.test)('Python - Notebook shows diagnostic for undefined variable', async function ({ app, hotKeys }) {
        ...
        await _test_setup_js_1.test.step('Add code with undefined variable', async () => {
            await notebooksPositron.addCodeToCell(0, 'x = 1\nprint(xx)');
            await notebooksPositron.expectCellContentAtIndexToBe(0, ['x = 1', 'print(xx)']);
        });
        await _test_setup_js_1.test.step('Verify diagnostic appears', async () => {
            await problems.expectDiagnosticsToBe({ badgeCount: 1, warningCount: 0, errorCount: 1 });
        });
        await _test_setup_js_1.test.step('Fix the error', async () => {
        ...
        await _test_setup_js_1.test.step('Verify diagnostic is cleared', async () => {
            await problems.expectDiagnosticsToBe({ badgeCount: 0, warningCount: 0, errorCount: 0 });
        });
    });
});
//# sourceMappingURL=lsp-diagnostics.test.js.map