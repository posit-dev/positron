...
test.describe('Top Action Bar - Interpreter Dropdown', {
	...
	test('Python - starts and shows running', async function ({ app }) {
	...
	test('Python - restarts and shows running', async function ({ app, python }) {
	...
	test('R - starts and shows running', async function ({ app }) {
	...
	test('R - stops and shows inactive', async function ({ app, r }) {
