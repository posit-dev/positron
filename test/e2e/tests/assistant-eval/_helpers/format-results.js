...
exports.GRADE_LABELS = void 0;
exports.formatResultsMarkdown = formatResultsMarkdown;
exports.formatResultsHtml = formatResultsHtml;
/**
 ...
 */
function parseToolsCalled(response) {
...
function formatResultsMarkdown(params) {
    ...
    const gradeLabel = exports.GRADE_LABELS[grade];
 ...
 */
function formatEvaluationMarkdown(explanation) {
 ...
 */
function formatResultsHtml(params) {
    const { testId, description, model, grade, explanation, question, response } = params;
    const toolsCalled = parseToolsCalled(response);
    const resultSymbol = grade === 'I' ? '✗' : '✓';
    const gradeLabel = exports.GRADE_LABELS[grade];
 ...
 */
function parseEvaluation(explanation) {
    const criteria = [];
    let explanationText = '';
 ...
 */
function formatEvaluationHtml(explanation) {
    const parsed = parseEvaluation(explanation);
    if (parsed.criteria.length === 0) {
        // No structured criteria found, just show the explanation
