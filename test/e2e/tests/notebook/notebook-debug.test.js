...
_test_setup_1.test.describe('Notebook Debugging', {
    tag: [_test_setup_1.tags.DEBUG, _test_setup_1.tags.NOTEBOOKS, _test_setup_1.tags.WEB, _test_setup_1.tags.WIN]
}, () => {
    _test_setup_1.test.beforeEach(async ({ app }) => {
    ...
    (0, _test_setup_1.test)('Python - Core debugging workflow: breakpoints, variable inspection, step controls, and output verification', async ({ app, logger, hotKeys }) => {
        const code = [
        ...
        // Verify final output
        await (0, test_1.expect)(app.workbench.notebooks.frameLocator.locator('text=Result from Positron: 40')).toBeVisible();
        // Clean up BPs
        await hotKeys.clearAllBreakpoints();
    });
});
//# sourceMappingURL=notebook-debug.test.js.map