...
_test_setup_1.test.describe('Quarto - Inline Output: DataFrame and Interactive HTML', {
    ...
    (0, _test_setup_1.test)('Python - Verify DataFrame output shows HTML only, not duplicate text and HTML', async function ({ python, app, openFile }) {
    ...
    (0, _test_setup_1.test)('Python - Verify interactive HTML widget persists correctly after close and reopen', async function ({ python, app, openFile, hotKeys }) {
        const { editors, inlineQuarto } = app.workbench;
        const filePath = (0, path_1.join)('workspaces', 'quarto_inline_output', 'interactive_plot.qmd');
        // Open a Quarto file and wait for the kernel to be ready
    ...
    (0, _test_setup_1.test)('Python - Verify interactive HTML widget persists correctly after window reload', async function ({ python, app, openFile, hotKeys }) {
        const { editors, inlineQuarto } = app.workbench;
        const filePath = (0, path_1.join)('workspaces', 'quarto_inline_output', 'interactive_plot.qmd');
        // Open a Quarto file and wait for the kernel to be ready
        await openFile(filePath);
...
//# sourceMappingURL=quarto-inline-output-dataframe.test.js.map