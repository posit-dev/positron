...
_test_setup_js_1.test.describe('Positron Notebooks: Action Bar Behavior', {
    ...
    (0, _test_setup_js_1.test)('Cell deletion using action bar', async function ({ app }) {
        ...
        // ========================================
        await _test_setup_js_1.test.step('Test 1: Delete selected cell (cell 2)', async () => {
        ...
        // ========================================
        await _test_setup_js_1.test.step('Test 2: Delete another cell (cell 3, originally cell 4)', async () => {
        ...
        // ========================================
        await _test_setup_js_1.test.step('Test 3: Delete last cell (cell 3, contains \'# Cell 5\')', async () => {
        ...
        // ========================================
        await _test_setup_js_1.test.step('Test 4: Delete first cell (cell 0)', async () => {
        ...
        // ========================================
        await _test_setup_js_1.test.step('Test 5: Delete remaining cells', async () => {
    ...
    (0, _test_setup_js_1.test)('Cell copy/paste using action bar', async function ({ app, hotKeys }) {
        const { notebooksPositron } = app.workbench;
    ...
    (0, _test_setup_js_1.test)('Cell actions with multiple cells selected', async function ({ app }) {
        const { notebooksPositron } = app.workbench;
...
//# sourceMappingURL=notebook-cell-action-bar.test.js.map