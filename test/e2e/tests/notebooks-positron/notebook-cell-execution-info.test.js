...
_test_setup_js_1.test.describe('Positron Notebooks: Cell Execution Footer', {
    tag: [_test_setup_1.tags.WIN, _test_setup_1.tags.WEB, _test_setup_1.tags.POSITRON_NOTEBOOKS]
}, () => {
    _test_setup_js_1.test.afterEach(async function ({ app }) {
        const { notebooksPositron } = app.workbench;
        await notebooksPositron.expectNoActiveSpinners();
    });
    (0, _test_setup_js_1.test)('Cell Execution Footer - Basic Functionality', async function ({ app }) {
        const { notebooks, notebooksPositron } = app.workbench;
        await _test_setup_js_1.test.step('Test Setup: Create notebook and select kernel', async () => {
        ...
        // ========================================
        await _test_setup_js_1.test.step('Cell 0 - Successful execution info display', async () => {
        ...
        // ========================================
        await _test_setup_js_1.test.step('Cell 1 - Failed execution info display', async () => {
        ...
        // ========================================
        await _test_setup_js_1.test.step('Cell 2 - Running execution info display', async () => {
        ...
        // ========================================
        await _test_setup_js_1.test.step('Cell 3 - Relative time display', async () => {
        ...
        // ========================================
        await _test_setup_js_1.test.step('Cell 4 - Footer visibility for never-run cell', async () => {
...
//# sourceMappingURL=notebook-cell-execution-info.test.js.map