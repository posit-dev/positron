...
_test_setup_js_1.test.describe('Positron Notebooks: Cell Copy-Paste Behavior', {
    tag: [_test_setup_1.tags.WIN, _test_setup_1.tags.WEB, _test_setup_1.tags.POSITRON_NOTEBOOKS]
}, () => {
    (0, _test_setup_js_1.test)('Single: Copy and paste cell content in various scenarios', async function ({ app }) {
        const { notebooksPositron } = app.workbench;
        await notebooksPositron.newNotebook({ codeCells: 5 });
        // ========================================
        // Test 1: Copy single cell and paste at end
        // ========================================
        await _test_setup_js_1.test.step('Test 1: Copy single cell and paste at end', async () => {
        ...
        // ========================================
        await _test_setup_js_1.test.step('Test 2: Cut single cell and paste at different position', async () => {
        ...
        // ========================================
        await _test_setup_js_1.test.step('Test 3: Copy cell and paste multiple times (clipboard persistence)', async () => {
            // Copy cell 0
        ...
        // ========================================
        await _test_setup_js_1.test.step('Test 4: Cut and paste at beginning of notebook', async () => {
    ...
    (0, _test_setup_js_1.test)('Multiselect: Cut from top and paste at bottom', async function ({ app, hotKeys }) {
        const { notebooksPositron } = app.workbench;
...
//# sourceMappingURL=notebook-copy-paste.test.js.map