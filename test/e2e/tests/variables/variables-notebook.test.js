...
_test_setup_1.test.describe('Variables Pane - Notebook', {
    tag: [_test_setup_1.tags.CRITICAL, _test_setup_1.tags.WEB, _test_setup_1.tags.VARIABLES, _test_setup_1.tags.NOTEBOOKS]
}, () => {
    (0, _test_setup_1.test)('R - Verify Variables pane basic function for notebook', {
    ...
    (0, _test_setup_1.test)('Python - Verify Variables pane basic function for notebook', async function ({ app }) {
    ...
    (0, _test_setup_1.test)('Python - Verify Variables available after reload', async function ({ app, hotKeys }) {
        const { notebooks, variables } = app.workbench;
        // Create a variable via a notebook
        await notebooks.createNewNotebook();
        await notebooks.selectInterpreter('Python');
    ...
    (0, _test_setup_1.test)('Python - Verify variables persist across cells', async function ({ app }) {
    ...
    (0, _test_setup_1.test)('Python - Verify Variables pane stays on notebook session after opening Data Explorer', {
        tag: [_test_setup_1.tags.DATA_EXPLORER]
    }, async function ({ app, hotKeys }) {
...
//# sourceMappingURL=variables-notebook.test.js.map