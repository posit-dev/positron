...
_test_setup_1.test.describe('Variables - Expanded View', { tag: [_test_setup_1.tags.WEB, _test_setup_1.tags.VARIABLES] }, () => {
    ...
    (0, _test_setup_1.test)('Python - Verify children values and types display when variable is expanded', async function ({ app, python }) {
        ...
        for (const variable of Object.keys(expectedData)) {
            ...
            (0, _test_setup_1.expect)(actualData).toEqual(expectedData[variable]);
        }
    });
    (0, _test_setup_1.test)('R - Verify getting large dataframe children should not cause problems', {
        ...
        for (let i = 0; i < 10; i++) {
            (0, _test_setup_1.expect)(childrenArray[i]).toEqual({ type: '', value: (i + 1).toString() });
        }
    });
});
const script = `
...
//# sourceMappingURL=variables-expanded.test.js.map