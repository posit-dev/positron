...
export function setup(logger: Logger) {
	describe('Layouts', () => {
		...
		describe('Stacked Layout', () => {
			...
			it('Verify stacked layout puts stuff in appropriate places [C656294] #nightly', async function () {
		...
		describe('Side-by-side Layout', () => {
			...
			it('Verify Side-by-side layout puts stuff in appropriate places [C656295] #nightly', async function () {
		...
		describe('Notebook Layout', () => {
			...
			it('Verify notebook layout puts stuff in appropriate places [C656296] #nightly', async function () {
