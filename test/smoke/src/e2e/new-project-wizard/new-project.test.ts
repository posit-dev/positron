...
test.describe('New Project Wizard', () => {
	test.describe('Python - New Project Wizard', () => {
		test.describe('Python Project with new environment', () => {
		...
		test.describe('Python Project with existing interpreter', () => {
	...
	test.describe('R - New Project Wizard', () => {
		...
		test.describe('R Project with Renv Environment', () => {
			test.beforeEach(async function ({ app }) {
				await app.workbench.positronConsole.waitForReadyOrNoInterpreter();
			});

			test('Accept Renv install [C633084]', async function ({ app }) {
			...
			test('Renv already installed [C656251]', async function ({ app }) {
			...
			test('Cancel Renv install [C656252]', async function ({ app }) {
