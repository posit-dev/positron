	...
	return () => {
		...
		const productJsonStream = gulp.src(['product.json'], { base: '.' })
			.pipe(jsonEditor((json: Record<string, unknown>) => {
				...
				// --- Start Positron ---
				// Stamp Positron-specific version metadata onto the product json.
				json.positronVersion = positronVersion;
				json.positronBuildNumber = positronBuildNumber;
				json.quality = releaseChannel;
				// --- End Positron ---
