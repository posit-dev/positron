...
export const indentationFilter = Object.freeze<string[]>([
	...
	// The SQL analyzer is Rust, whose toolchain formats with spaces, and its lock file is
	// generated by cargo.
	'!extensions/positron-sql/sql-analyzer/**/*.rs',
	'!extensions/positron-sql/sql-analyzer/Cargo.lock',
	// --- End Positron ---
]);
...
export const copyrightFilter = Object.freeze<string[]>([
	...
	'!extensions/positron-r/resources/testing/**',
	`!**/*.jsonl`,
	// Cargo manifests and lock files are generated and edited by the Rust toolchain, which has
	// no reason to preserve a header. Neither does the CLI's own Cargo.toml carry one.
	'!**/Cargo.toml',
	'!**/Cargo.lock',
	// --- End Positron ---
