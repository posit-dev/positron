...
/**
 * PositronToggleActionViewItem class. Provides the visual representation of a
 * PositronToggleAction and keeps it up to date when the state of the underlying
 * IAction changes.
 */
