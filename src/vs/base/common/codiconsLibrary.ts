...
export const codiconsLibrary = {
	...
	positronAssistantLayout: register('positron-assistant-layout', 0xf293),
	positronAssistantPaused: register('positron-assistant-paused', 0xf294),
	...
	positronDbColumnKey: register('positron-db-column-key', 0xf29d),
	positronDbColumn: register('positron-db-column', 0xf29e),
	positronDbColumns: register('positron-db-columns', 0xf29f),
	positronDbDatabase: register('positron-db-database', 0xf2a0),
	positronDbIndex: register('positron-db-index', 0xf2a1),
	positronDbIndexes: register('positron-db-indexes', 0xf2a2),
	positronDbSchema: register('positron-db-schema', 0xf2a3),
