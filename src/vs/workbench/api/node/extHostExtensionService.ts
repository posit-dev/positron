...
export class ExtHostExtensionService extends AbstractExtHostExtensionService {
	...
	protected async _beforeAlmostReadyToRunExtensions(): Promise<void> {
		...
		await this._store.add(this._instaService.createInstance(NodeModuleRequireInterceptor, extensionApiFactory, positronExtensionApiFactory, { mine: this._myRegistry, all: this._globalRegistry }))
			.install();
		// --- End Positron ---
