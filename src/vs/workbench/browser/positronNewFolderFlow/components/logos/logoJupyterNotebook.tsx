...
export const LogoJupyterNotebook = () => (
	...
	// Jupyter logo svg file located at src/vs/workbench/browser/positronNewFolderFlow/components/logos/logoJupyterNotebook.svg,
	// and then adapted for sizing and unique ids to avoid conflicts with other logos.
	// Please see the corresponding license for the original Jupyter logo svg file in the top-level NOTICE file.
	<svg
