...
export const LogoRProject = () => (
	...
	// R logo svg file located at src/vs/workbench/browser/positronNewFolderFlow/components/logos/logoRProject.svg
	// and then adapted for sizing and unique ids to avoid conflicts with other logos.
	// Please see the corresponding license for the original R logo svg file in the top-level ThirdPartyNotices.txt.
	<svg
