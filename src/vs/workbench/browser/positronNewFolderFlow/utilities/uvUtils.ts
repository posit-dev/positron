 ...
 * extension: ok is true if uv is installed (or was already), and error carries a message to
 * show when the install failed for a reason other than the user declining.
 */
