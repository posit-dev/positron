...
// --- Start Positron ---
// Upstream matches the title bar's `editorActionsEnabled` getter here, gating the
// layout control menu on whether editor actions render in the title bar:
//
...
// and removes the upstream setting (see LayoutSettings), so editor actions never render
// in the title bar through this mechanism. The condition is therefore always false.
const EditorActionsInTitleBar = ContextKeyExpr.false();
// --- End Positron ---
