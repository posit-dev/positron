...
export class ToolConfirmationSubPart extends AbstractToolConfirmationSubPart {
	...
	constructor(
		...
		const allowLabel = toolInvocation.toolId === 'executeCode'
		...
		this.render({
			...
			// --- Start Positron ---
			// Use our allowLabel instead of always "Allow"
			allowLabel: toolInvocation.confirmationMessages.confirmResults ? localize('allowReview', "Allow and Review") : allowLabel,
			// --- End Positron ---
