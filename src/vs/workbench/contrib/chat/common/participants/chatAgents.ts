...
import { IChatAgentEditedFileEvent, IChatProgressHistoryResponseContent, IChatRequestModeInstructions, IChatRequestVariableData, IChatTokenUsage, ISerializableChatAgentData } from '../model/chatModel.js';
...
export interface IChatAgentResult {
	...
	// --- Start Positron ---
	// Add tokenUsage to the metadata
	readonly metadata?: {
