...
export namespace ChatMode {
	// --- Start Positron ---
	// Rename Ask mode to be more aligned with Assistant branding
	...
	export const Ask = new BuiltinChatMode(ChatModeKind.Ask, 'Ask', localize('chatDescription', "Ask Assistant"), Codicon.question);
	// --- End Positron ---
