...
export namespace ChatContextKeys {
	...
	// --- Start Positron ---
	export const editEnabled = new RawContextKey<boolean>('chatEditEnabled', false, { type: 'boolean', description: localize('chatEditEnabled', "True when the chat edit is enabled.") });
	// --- End Positron ---
