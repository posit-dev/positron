...
// The chat extension id is product-specific: Positron uses 'positron.positron-assistant'
// rather than upstream's 'GitHub.copilot-chat'. Derive it from the product service so these
// assertions stay correct across forks instead of hardcoding the upstream value.
