...
export class WebviewElement extends Disposable implements IWebviewElement, WebviewFindDelegate {
	...
	constructor(
		...
		if (initInfo.options.enableFindWidget) {
			// --- Start Positron ---
			// Pass `this._options.webviewFindDelegate || this` so that a WebviewFindDelegate
			// passed in through WebviewOptions takes over when provided.
			this._webviewFindWidget = this._register(this._instantiationService.createInstance(WebviewFindWidget, this._options.webviewFindDelegate || this));
			// --- End Positron ---
		}
