...
// --- Begin Positron ---
import { IPositronNotebookService, setMinimalUiCSSVariables } from 'vs/workbench/services/positronNotebook/browser/positronNotebookService';
// --- End Positron ---
		...
		this._register(
			this._positronNotebookService.onNotebookMinimalUiModeChanged({
				callback: (useMinimalUi) => {
					...
					setMinimalUiCSSVariables(this._overlayContainer, useMinimalUi);
				},
