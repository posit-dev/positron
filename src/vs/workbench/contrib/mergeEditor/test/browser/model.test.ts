			...
			model => {
				assert.deepStrictEqual(model.getProjections(), {
					base: [
						...
						"import { autorun, IReader, observableFromEvent, ObservableValue } from './.js';",
						"⟧₁import { LineRange } from '../../browser/model/lineRange.js';",
						'',
					],
					input1: [
						"import { h } from '../../../../../base/browser/dom.js';",
						"import { Disposable, IDisposable } from '../../../../../base/common/lifecycle.js';",
						"⟦import { observableSignalFromEvent } from '../../../../../base/common/observable.js';",
						"⟧₀import { CodeEditorWidget } from '../../../../../editor/browser/widget/codeEditorWidget.js';",
						"⟦import { autorun, IReader, observableFromEvent } from './.js';",
						"⟧₁import { LineRange } from '../../browser/model/lineRange.js';",
						'',
					],
					input2: [
					...
					result: [
						...
						"import { Disposable, IDisposable } from '../../../../../base/common/lifecycle.js';",
						"⟦import { observableSignalFromEvent } from '../../../../../base/common/observable.js';",
						"⟧{1✓}₀import { CodeEditorWidget } from '../../../../../editor/browser/widget/codeEditorWidget.js';",
						'⟦<<<<<<< Updated upstream',
						"import { autorun, IReader, observableFromEvent, ObservableValue } from './.js';",
						'=======',
						"import { autorun, IReader, observableFromEvent } from './.js';",
						'>>>>>>> Stashed changes',
						"⟧{unrecognized}₁import { LineRange } from '../../browser/model/lineRange.js';",
						'',
					],
				});
			}
