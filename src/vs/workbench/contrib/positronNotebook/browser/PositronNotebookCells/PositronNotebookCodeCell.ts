...
export class PositronNotebookCodeCell extends PositronNotebookCellGeneral implements IPositronNotebookCodeCell {
	...
	constructor(
		...
		this.lastExecutionDuration = observableValue<number | undefined, void>('lastExecutionDuration', this.calculateExecutionDuration());
		this.lastExecutionOrder = observableValue<number | undefined, void>('lastExecutionOrder', cellModel.internalMetadata.executionOrder);
		this.lastRunSuccess = observableValue<boolean | undefined, void>('lastRunSuccess', cellModel.internalMetadata.lastRunSuccess ?? undefined);
		this.lastRunEndTime = observableValue<number | undefined, void>('lastRunEndTime', cellModel.internalMetadata.runEndTime ?? undefined);
