...
const positronOutlineViewIcon = registerIcon('positron-outline-view-icon', Codicon.positronOutline, nls.localize('positronOutlineViewIcon', 'View icon of the Positron outline view.'));
