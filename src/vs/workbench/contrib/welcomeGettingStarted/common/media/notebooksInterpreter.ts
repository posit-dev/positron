...
Positron supports Python interpreters from virtual environments created via \`venv\`, \`uv\`, \`pyenv\`, \`conda\`, and other Python installations, as well as R interpreters. Your selected interpreter will be used for running notebook cells and providing language intelligence.
