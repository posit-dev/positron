	...
	*/
	...
	private buildGettingStartedWalkthroughsList(): GettingStartedIndexList<IResolvedWalkthrough> {
		...
		const rankWalkthrough = (e: IResolvedWalkthrough) => {
			 ...
			 */
			const allowedWalkthroughIds = ['ms-python.python#positron.migrateFromVSCode', 'positron.positron-r#positron.r.migrateFromRStudio', 'positron.positron-notebooks-helpers#positron-notebook-intro'];
