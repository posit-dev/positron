...
class ReportExtensionSlowAction extends Action {
	...
	override async run(): Promise<void> {
		...
		// --- Start Positron ---
		// Added Positron version and renamed VS Code to Code - OSS
...
- Extension Version: \`${this.extension.version}\`
- OS Version: \`${osVersion}\`
- Version: \`${this._productService.positronVersion}+${this._productService.positronBuildNumber}\`
- Code - OSS version: \`${this._productService.version}\`\n\n${message}`);
		// --- End Positron ---
