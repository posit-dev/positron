...
export const MicrosoftFoundry = (props: SVGProps<SVGSVGElement>) => {
	...
	const fill0 = `lobe-icons-azure-ai-fill-0-${uid}`;
	const fill1 = `lobe-icons-azure-ai-fill-1-${uid}`;
	const fill2 = `lobe-icons-azure-ai-fill-2-${uid}`;
	return (
		<svg
			height='1em'
			style={{
		...
		>
			...
			/>
			<defs>
				<linearGradient gradientUnits='userSpaceOnUse' id={fill0} x1='18.242' x2='14.191' y1='16.837' y2='.616'>
				...
				<linearGradient gradientUnits='userSpaceOnUse' id={fill1} x1='19.782' x2='19.782' y1='.34' y2='23.222'>
				...
				<linearGradient gradientUnits='userSpaceOnUse' id={fill2} x1='18.404' x2='3.236' y1='.859' y2='25.183'>
					<stop stopColor='#DA7ED0' />
