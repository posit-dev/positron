...
export class IssueReporterModel {
	...
	serialize(): string {
		...
		// The `versionInfo` property is populated in src/vs/workbench/contrib/issue/browser/baseIssueReporterService.ts.
		/*
		return `
...
${this._data.issueDescription}
${this.getExtensionVersion()}
Version: ${this._data.versionInfo && this._data.versionInfo.positronVersion}
Code - OSS version: ${this._data.versionInfo && this._data.versionInfo.vscodeVersion}
OS version: ${this._data.versionInfo && this._data.versionInfo.os}
Modes:${modes.length ? ' ' + modes.join(', ') : ''}
${this.getRemoteOSes()}
${this.getInfos()}
