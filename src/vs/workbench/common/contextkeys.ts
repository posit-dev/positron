...
export const PositronConsoleInputFocused = new RawContextKey<boolean>('positronConsoleInputFocused', false, localize('positronConsoleInputFocused', "Whether the Positron Console input editor has keyboard focus"));
