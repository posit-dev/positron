...
export interface IPositronVariablesInstance {
	...
	/**
	 * Gets the top-level variable items currently known for this session.
	 */
	readonly variableItems: IVariableItem[];
	 ...
	 * changes.
	 */
	readonly onDidChangeStatus: Event<RuntimeClientStatus>;
