...
// --- Start Positron ---
import { PartViewInfo } from '../../workbench/services/positronLayout/browser/interfaces/positronLayoutService.js';
import { CustomPositronLayoutDescription, KnownPositronLayoutParts } from '../../workbench/services/positronLayout/common/positronCustomViews.js';
// --- End Positron ---
...
export class Workbench extends Disposable implements IWorkbenchLayoutService {
	...
	// --- Start Positron ---
	minimizePanel(): void {
		// No-op: Panel minimization not supported in sessions layout
	}

	restorePanel(): void {
		// No-op: Panel restoration not supported in sessions layout
	}

	maximizePanel(): void {
		// No-op: Panel maximization not supported in sessions layout
	}

	isPanelMinimized(): boolean {
		return false; // Panel minimization not supported
	}

	enterCustomLayout(_layout: CustomPositronLayoutDescription): void {
		// No-op: Custom layouts not supported in sessions layout
	}

	getPartViewInfo(_part: KnownPositronLayoutParts): PartViewInfo {
		// Return stub info - custom layouts not supported in sessions layout
		return {
			partView: undefined!,
